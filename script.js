document.addEventListener("DOMContentLoaded", function () {
    ...
    let numbersToAsk = shuffleArray([...Array(10).keys()].map(x => x + 1));
    ...
    function generateRandomOptions(correctAnswer, count) {
      ...
      while (options.length < count) {
        const randomOption = getRandomInt(1, 20); // Puedes ajustar el rango según tus necesidades
    ...
    function resetGame() {
      numbersToAsk = shuffleArray([...Array(10).keys()].map(x => x + 1));
